<section class="relative pt-28 personal-wrapper overflow-hidden bg-amber-500/5" id="home">
    ...
    <div class="container">
        <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
            <div>
                <h4 class="font-bold lg:text-[40px] text-3xl lg:leading-normal leading-normal mb-4">Hey! I'm <br><span class="typewrite text-amber-500" data-period="2000" data-type='[ "Hasibul Islam", "Website Developer", "Web Desinger" ]'> <span class="wrap"></span> </span></h4>
                <p class="text-slate-400 max-w-xl">Obviously I'm a Full Stack Web Developer over 1 years of experience. Experienced with all stages of the development.</p>
            ...
            <div class="relative">
                <img src="{{asset('frontend/images/hero/himel.png')}}" alt="">
                ...
                <div class="absolute lg:bottom-20 md:bottom-10 bottom-2 ltr:md:-left-5 ltr:left-2 rtl:md:-right-5 rtl:right-2 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 m-3 w-44 text-center">
                    <span class="text-3xl font-medium mb-0"><span class="counter-value font-bold" data-target="125">1</span>+</span>
