            ...
            <div class="tiny-three-item">
                <div class="tiny-slide">
                    ...
                    <div class="customer-testi">
                        ...
                        <div class="text-center mt-5">
                            <img src="{{asset('frontend/images/client/01.j')}}pg" class="h-14 w-14 rounded-full shadow-md mx-auto mb-1" alt="">
                ...
                <div class="tiny-slide">
                    ...
                    <div class="customer-testi">
                        ...
                        <div class="text-center mt-5">
                            <img src="{{asset('frontend/images/client/02.j')}}pg" class="h-14 w-14 rounded-full shadow-md mx-auto mb-1" alt="">
                ...
                <div class="tiny-slide">
                    ...
                    <div class="customer-testi">
                        ...
                        <div class="text-center mt-5">
                            <img src="{{asset('frontend/images/client/03.j')}}pg" class="h-14 w-14 rounded-full shadow-md mx-auto mb-1" alt="">
                ...
                <div class="tiny-slide">
                    ...
                    <div class="customer-testi">
                        ...
                        <div class="text-center mt-5">
                            <img src="{{asset('frontend/images/client/04.j')}}pg" class="h-14 w-14 rounded-full shadow-md mx-auto mb-1" alt="">
                ...
                <div class="tiny-slide">
                    ...
                    <div class="customer-testi">
                        ...
                        <div class="text-center mt-5">
                            <img src="{{asset('frontend/images/client/05.j')}}pg" class="h-14 w-14 rounded-full shadow-md mx-auto mb-1" alt="">
                            <a href="#" class="text-base font-medium h5 hover:text-amber-500 duration-500 ease-in-out">Barbara McIntosh</a>
                            <span class="text-slate-400 text-sm block">Manager</span>
                        </div>
                    </div>
                ...
                <div class="tiny-slide">
                    ...
                    <div class="customer-testi">
                        ...
                        <div class="text-center mt-5">
                            <img src="{{asset('frontend/images/client/06.j')}}pg" class="h-14 w-14 rounded-full shadow-md mx-auto mb-1" alt="">
