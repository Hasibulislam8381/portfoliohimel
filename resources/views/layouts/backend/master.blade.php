...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('frontend/img/logo/r-fav.png') }}">
            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="#" class="">
                            <span class="logo-sm">
                                <img src="{{ asset('frontend/img/logo/rents2.png') }}" alt="" class="mt-3"
                                    height="60">
                            </span>
                        </a>
                    </div>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('admin') }}" class="">
                                <img src="{{ asset('backend/images/icon/dashboard.png') }}" class="property_icon" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="text-lg-end text-sm-start">
                                Design & Developed by <a href="https://www.techdynobd.com/">TechdynoBD</a>
                            </div>
                        </div>
                    </div>
                </div>
